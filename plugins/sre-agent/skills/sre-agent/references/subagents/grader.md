...
Discovery receipt: (for causal blocked-unreachable, a final Proximate-only whose unresolved upstream/mechanism lead still had reachable in-hand keys, or pure-noise/clean target closure)
