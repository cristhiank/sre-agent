...
Follow-up: dispatch? (yes/no) / single dispatch or awaited parallel-sync wave (one specialist per independent discriminator, up to 5, one round) / focus / required observations / stop condition
