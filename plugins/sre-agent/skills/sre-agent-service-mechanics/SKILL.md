...
The implementation, configuration, or runtime/control-plane state of the implicated component and of comparable healthy paths; the operations performed and their ordering; the specific difference between the failing path and a known-good path; any authoritative source that confirms or refutes the proposed mechanism.
